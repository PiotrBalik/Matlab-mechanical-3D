...
ggg=DesignParams.ggg;
gammaM0 = DesignParams.gammaM0;   
gammaM1 = DesignParams.gammaM1;
steelGrade = DesignParams.steelGrade;
Ned = DesignParams.Ned;
epsilon = DesignParams.epsilon;
ita = DesignParams.ita;
Ved = DesignParams.Ved;
MYed = DesignParams.MYed;
MZed = DesignParams.MYed;
L = DesignParams.L;
C1 = DesignParams.C1;
E = DesignParams.E;
G = DesignParams.G;
...
%     end
    ...
    Cmz=Cmy;  % Cmz = Cmy =CmLT. Acoording to EC3 page 80 ................
...
if sc == 2 %column    % I CHANGEEEEEEEEEEEEED THE SECTIONTYPE >>>>>>>>>>>>>>>>>>>>>>>>>>>
%  IT WAS   if sectionslassification == 2 %column   
    Defl = HD;
else
    Defl = VD;
end
