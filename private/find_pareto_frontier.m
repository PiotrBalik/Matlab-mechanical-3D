%--------------------------------------------------------------------------
% Sisi Ma (2021). find_pareto_frontier
% (https://www.mathworks.com/matlabcentral/fileexchange/45885-find_pareto_frontier),
% MATLAB Central File Exchange. Retrieved March 5, 2021. 
...
%
%--------------------------------------------------------------------------
function [member_value, membership]=find_pareto_frontier(input)
out=[];
